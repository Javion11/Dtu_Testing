...
args.input_dir = "/algo/algo/hanjiawei/denoise_result/mvsnet_cascade_cleanimg/newunet_newfpn_dynamic_lossweight_trainval/"
...
def subroutine(params):
    ...
    for img_name in img_name_list:
        ...
        # img_net = torch.from_numpy(np.array(Image.open(os.path.join(input_dir, scan, img_name_jpg))) / 255.0)
        ...
        img_net = np.array(Image.open(os.path.join(input_dir, scan, "rgb", img_name_jpg)))
