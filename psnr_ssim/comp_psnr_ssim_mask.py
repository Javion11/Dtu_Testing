...
args.input_dir = "/algo/algo/hanjiawei/denoise_result/mvsnet_denoise_clean_newunet_newfeaturenet_l1_lossweight_dynamic_method3/"
...
def subroutine(params):
    ...
    for img_name in img_name_list:
        ...
        img_noise_resize = F.interpolate(img_noise_unsqueeze, size=(img_net.size()[1], img_net.size()[2]), mode='area').squeeze(0)
        ...
        confidence = read_pfm(os.path.join(target_dir, scan, "confidence", img_name.spilt('.')[0], ".pfm"))[0]
